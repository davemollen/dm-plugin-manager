  ...
  return (
    <div className="text-sm">
      <h3 className="font-sans text-2xl font-bold tracking-wide">
        Unable to connect with MOD device.
      </h3>
      <p className="mt-2 max-w-lg">
        Make sure your MOD device is hooked up via USB and try to reconnect. If
        it still doesn't connect, try to reboot your MOD and connect again.
      </p>
